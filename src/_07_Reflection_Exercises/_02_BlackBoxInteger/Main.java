package _07_Reflection_Exercises._02_BlackBoxInteger;
...
public class Main {
    public static void main(String[] args) throws NoSuchMethodException, InvocationTargetException, InstantiationException, IllegalAccessException, NoSuchFieldException{
        ...
        while (!command.equals("END")) {
            ...
            invokeMethodName(methodName, value, box, boxClass);
    ...
    private static void invokeMethodName(String methodName, int value, BlackBoxInt box, Class boxClass) throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
